    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-dark navbar-expand-md shadow align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="index.php"><i class="fas fa-home" style="color: rgba(255,255,255,0.5);"></i><span style="color: rgba(255,255,255,0.5);">Home</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="data/admin-add-data.php"><i class="fas fa-database" style="color: rgba(255,255,255,0.5);"></i><span style="color: rgba(255,255,255,0.5);">Data</span></a></li>
                    <li class="nav-item"><a class="nav-link" href=""><i class="fas fa-user-circle" style="color: rgb(255,255,255);"></i><span style="color: rgb(255,255,255);"><strong>Profile</strong></span></a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown show no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="true" href=""><span class="d-none d-lg-inline mr-2 text-gray-600 small"><strong>Admin</strong></span><i class="fas fa-user-shield border rounded-circle border-dark" style="font-size: 18px;line-height: 28px;height: 32px;width: 32px;color: rgb(0,0,0);text-align: center;"></i></a>
                                    <div
                                        class="dropdown-menu show shadow dropdown-menu-right animated--grow-in"><a class="dropdown-item text-secondary" href=""><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Profile</a>
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-1"><strong>Profile</strong></h3>
            </div>
            <!-- End: #Content_Heading -->
            <!-- Start: #Content_Line -->
            ...
            <div class="container-fluid">
                <div class="row" style="margin: 5px;padding: 0px;">
                    <div class="col"><span>Ganti pengaturan login</span></div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="table-responsive" style="box-shadow: 0px 0px 4px 2px rgba(128,128,128,0.5);border-radius: 16px;margin: 5px;padding: 5px;">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th style="color: rgb(0,0,0);">Username</th>
                                        <th style="color: rgb(0,0,0);">Password</th>
                                    </tr>
                                </thead>
                                <tbody style="color: rgb(0,0,0);">
                                    <tr style="color: rgb(0,0,0);">
                                        <td style="color: rgb(0,0,0);"><input type="text"></td>
                                        <td style="color: rgb(0,0,0);"><input type="password"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td style="text-align: right;"><button class="btn btn-primary" type="button">Submit</button></td>
                                    </tr>
