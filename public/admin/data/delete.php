...
<?php
	...
	$query="DELETE from tbl_main where id='$id_pt'";
												...
												<div class="col-lg-6">
														<div class="p-5">
																<div class="text-center">
																		<h5 class="text-dark mb-4"><strong>Data berhasil dihapus</strong><br><br>silahkan tunggu ...<br><br><i class="fas fa-map-marker swing animated infinite" style="text-align: center;font-size: 70px;"></i></h5>
																</div>
														</div>
												</div>
										</div>
